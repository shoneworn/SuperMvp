...
public class NumberUtils {
    ...
    public static boolean isParsable(String str) {
        return StringUtils.endsWith(str, ".") ? false : (StringUtils.startsWith(str, "-") ? isDigits(StringUtils.replaceOnce(str.substring(1), ".", "")) : isDigits(StringUtils.replaceOnce(str, ".", "")));
    }
