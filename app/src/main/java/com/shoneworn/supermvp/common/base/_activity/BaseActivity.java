...
public abstract class BaseActivity<T extends PresenterWrapper> extends BeamActivity<T>  implements BGASwipeBackHelper.Delegate, ViewTreeObserver.OnGlobalLayoutListener {
