...
public abstract class BeamFrameLayout<PresenterType extends PresenterWrapper> extends FrameLayout implements BaseView<PresenterType> {

    private PresenterType presenter;
    protected Context ctx;
    protected LayoutInflater layoutInflater;

    public BeamFrameLayout(Context context) {
        this(context, (AttributeSet) null);
    }

    public BeamFrameLayout(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BeamFrameLayout(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        this.beamLayout(context, attrs, defStyleAttr, 0);
    }

    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    public BeamFrameLayout(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
