...
public abstract class BeamRelativeLayout<PresenterType extends PresenterWrapper> extends RelativeLayout implements BaseView<PresenterType> {
    ...
    public BeamRelativeLayout(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BeamRelativeLayout(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        this.beamLayout(context, attrs, defStyleAttr, 0);
    }

    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    public BeamRelativeLayout(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
