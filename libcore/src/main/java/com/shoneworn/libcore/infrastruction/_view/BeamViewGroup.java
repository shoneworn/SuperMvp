...
public abstract class BeamViewGroup<PresenterType extends PresenterWrapper> extends ViewGroup implements BaseView<PresenterType> {

    private PresenterType presenter;
    protected Context ctx;
    protected LayoutInflater layoutInflater;

    public BeamViewGroup(Context context) {
        this(context, (AttributeSet) null);
    }

    public BeamViewGroup(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BeamViewGroup(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        this.beamLayout(context, attrs, defStyleAttr, 0);
    }

    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    public BeamViewGroup(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
