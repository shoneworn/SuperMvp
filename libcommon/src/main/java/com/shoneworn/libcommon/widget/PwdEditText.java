...
public class PwdEditText extends EditText {
    ...
    private OnPwdTextChangeListener mPwdTextChangeListener;
    private OnPwdFocusChangeListener mPwdFocusChangeListener;
    ...
    public PwdEditText(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        setOnFocusChangeListener(new OnFocusChangeListener() {
            ...
            public void onFocusChange(View v, boolean hasFocus) {
                ...
                if (mPwdFocusChangeListener != null) {
                    mPwdFocusChangeListener.onFocusChange(v, hasFocus);
                }
            }
        });
    }
    ...
    private void initAttrs(Context context, AttributeSet attrs, int defStyleAttr) {
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.PwdEditText, defStyleAttr, 0);

        mSeparator = a.getString(R.styleable.PwdEditText_petSeparator);
        disableClear = a.getBoolean(R.styleable.PwdEditText_petDisableClear, false);
        mClearResId = a.getResourceId(R.styleable.PwdEditText_petClearDrawable, NO_ID);
        togglePwdDrawableEnable = a.getBoolean(R.styleable.PwdEditText_petTogglePwdDrawableEnable, true);
        mShowPwdResId = a.getResourceId(R.styleable.PwdEditText_petShowPwdDrawable, NO_ID);
        mHidePwdResId = a.getResourceId(R.styleable.PwdEditText_petHidePwdDrawable, NO_ID);
        disableEmoji = a.getBoolean(R.styleable.PwdEditText_petDisableEmoji, false);
        String pattern = a.getString(R.styleable.PwdEditText_petPattern);
        a.recycle();
        ...
        if (!disableClear) {
            if (mClearResId == NO_ID)
                mClearResId = R.drawable.pet_svg_ic_clear_24dp;
            mClearDrawable = context.getResources().getDrawable(mClearResId);
            if (mClearDrawable != null) {
                mClearDrawable.setBounds(0, 0, mClearDrawable.getIntrinsicWidth(),
                        mClearDrawable.getIntrinsicHeight());
                if (mClearResId == R.drawable.pet_svg_ic_clear_24dp)
        ...
        if (!mSeparator.isEmpty() && !isPwdInputType && pattern != null && !pattern.isEmpty()) {
            ...
            if (!ok) {
                Log.e(TAG, "the Pattern format is incorrect!");
            }
        }
    }
    ...
    private void dealWithInputTypes(boolean fromXml) {
        ...
        if (isPwdInputType) {
            ...
            if (mShowPwdResId == -1)
                mShowPwdResId = R.drawable.pet_svg_ic_show_password_24dp;
            if (mHidePwdResId == -1)
                mHidePwdResId = R.drawable.pet_svg_ic_hide_password_24dp;
            int tId = isPwdShow ? mShowPwdResId : mHidePwdResId;
            mTogglePwdDrawable = getContext().getResources().getDrawable(tId);
            if (mShowPwdResId == R.drawable.pet_svg_ic_show_password_24dp ||
                    mHidePwdResId == R.drawable.pet_svg_ic_hide_password_24dp) {
            ...
            if (!disableClear) {
                mBitmap = getBitmapFromVectorDrawable(getContext(), mClearResId,
                        mClearResId == R.drawable.pet_svg_ic_clear_24dp); // clearDrawable
            }
        }
        ...
        if (hasFocused && mBitmap != null && isPwdInputType && !isTextEmpty()) {
            if (mLeft * mTop == 0) {
                mLeft = getMeasuredWidth() - getPaddingRight() -
                        mTogglePwdDrawable.getIntrinsicWidth() - mBitmap.getWidth() - dp2px(8);
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        if (hasFocused && isPwdInputType && event.getAction() == MotionEvent.ACTION_UP) {
            ...
            if (isAreaX && isAreaY) {
                ...
                mTogglePwdDrawable = getContext().getResources().getDrawable(isPwdShow ?
    ...
    private class TextWatcherImpl implements TextWatcher {
        ...
        public void beforeTextChanged(CharSequence s, int start, int count, int after) {
            mOldLength = s.length();
            if (mPwdTextChangeListener != null) {
                mPwdTextChangeListener.beforeTextChanged(s, start, count, after);
            }
        }
        ...
        public void onTextChanged(CharSequence s, int start, int before, int count) {
            ...
            if (mPwdTextChangeListener != null) {
                mPwdTextChangeListener.onTextChanged(s, start, before, count);
            }
        }
        ...
        public void afterTextChanged(Editable s) {
            ...
            if (mSeparator.isEmpty()) {
                if (mPwdTextChangeListener != null) {
                    mPwdTextChangeListener.afterTextChanged(s);
                }
     ...
     */
    public void setOnPwdTextChangeListener(OnPwdTextChangeListener listener) {
        this.mPwdTextChangeListener = listener;
    }

    public void setOnPwdFocusChangeListener(OnPwdFocusChangeListener listener) {
        mPwdFocusChangeListener = listener;
    }
    ...
    public interface OnPwdFocusChangeListener {
