package com.shoneworn.libcommon.smartrefresh.layout;
...
import com.shoneworn.libcommon.smartrefresh.layout.api.DefaultRefreshFooterCreator;
import com.shoneworn.libcommon.smartrefresh.layout.api.DefaultRefreshHeaderCreator;
import com.shoneworn.libcommon.smartrefresh.layout.api.DefaultRefreshInitializer;
import com.shoneworn.libcommon.smartrefresh.layout.api.RefreshContent;
import com.shoneworn.libcommon.smartrefresh.layout.api.RefreshFooter;
import com.shoneworn.libcommon.smartrefresh.layout.api.RefreshHeader;
import com.shoneworn.libcommon.smartrefresh.layout.api.RefreshInternal;
import com.shoneworn.libcommon.smartrefresh.layout.api.RefreshKernel;
import com.shoneworn.libcommon.smartrefresh.layout.api.RefreshLayout;
import com.shoneworn.libcommon.smartrefresh.layout.api.ScrollBoundaryDecider;
import com.shoneworn.libcommon.smartrefresh.layout.constant.DimensionStatus;
import com.shoneworn.libcommon.smartrefresh.layout.constant.RefreshState;
import com.shoneworn.libcommon.smartrefresh.layout.constant.SpinnerStyle;
import com.shoneworn.libcommon.smartrefresh.layout.footer.FalsifyFooter;
import com.shoneworn.libcommon.smartrefresh.layout.header.FalsifyHeader;
import com.shoneworn.libcommon.smartrefresh.layout.impl.RefreshContentWrapper;
import com.shoneworn.libcommon.smartrefresh.layout.impl.RefreshFooterWrapper;
import com.shoneworn.libcommon.smartrefresh.layout.impl.RefreshHeaderWrapper;
import com.shoneworn.libcommon.smartrefresh.layout.listener.OnLoadMoreListener;
import com.shoneworn.libcommon.smartrefresh.layout.listener.OnMultiPurposeListener;
import com.shoneworn.libcommon.smartrefresh.layout.listener.OnRefreshListener;
import com.shoneworn.libcommon.smartrefresh.layout.listener.OnRefreshLoadMoreListener;
import com.shoneworn.libcommon.smartrefresh.layout.listener.OnStateChangedListener;
import com.shoneworn.libcommon.smartrefresh.layout.listener.OnTouchRefreshLoadMoreListener;
import com.shoneworn.libcommon.smartrefresh.layout.util.DelayedRunnable;
import com.shoneworn.libcommon.smartrefresh.layout.util.DensityUtil;
import com.shoneworn.libcommon.smartrefresh.layout.util.ViscousFluidInterpolator;
...
import static com.shoneworn.libcommon.smartrefresh.layout.util.DensityUtil.dp2px;
import static com.shoneworn.libcommon.smartrefresh.layout.util.SmartUtil.fling;
import static com.shoneworn.libcommon.smartrefresh.layout.util.SmartUtil.getColor;
import static com.shoneworn.libcommon.smartrefresh.layout.util.SmartUtil.isContentView;
...
public class SmartRefreshLayout extends ViewGroup implements RefreshLayout, NestedScrollingParent/*, NestedScrollingChild*/ {
    ...
    protected boolean mEnableFooterLocked = true;
    ...
    public SmartRefreshLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mEnableFooterLocked = ta.getBoolean(R.styleable.SmartRefreshLayout_srlEnableFooterLocked, mEnableFooterLocked);
        ...
        if (!thisView.isInEditMode()) {
            ...
            if (mRefreshHeader == null) {
                if (sHeaderCreator != null) {
                    ...
                    setRefreshHeader(new FalsifyHeader(thisView.getContext()));
                }
            }
            if (mRefreshFooter == null) {
                if (sFooterCreator != null) {
                    ...
                    setRefreshFooter(new FalsifyFooter(thisView.getContext()));
                    mEnableLoadMore = old;
                }
            } else {
                mEnableLoadMore = mEnableLoadMore || !mManualLoadMore;
...
//    }
    ...
    public MotionEvent currentTouchEvent;

    public MotionEvent getLastTouchEvent() {
        return lastTouchEvent;
    }

    private OnTouchRefreshLoadMoreListener onTouchRefreshLoadMoreListener;

    public void setOnTouchRefreshLoadMoreListener(OnTouchRefreshLoadMoreListener onTouchRefreshLoadMoreListener) {
        this.onTouchRefreshLoadMoreListener = onTouchRefreshLoadMoreListener;
    }
        ...
        if (oldState != state) {
            ...
            switch (mState) {
                case None:
                    ...
                    if (lastTouchEvent != null && onTouchRefreshLoadMoreListener != null) {
                        onTouchRefreshLoadMoreListener.onMonitorTouchRequestEnd();
                    }
                    lastTouchEvent = null;
                    break;
                case RefreshReleased:
                    ...
                    if (lastTouchEvent != null && onTouchRefreshLoadMoreListener != null) {
                        onTouchRefreshLoadMoreListener.onMonitorTouchRefresh();
                    }
                    break;
                case LoadReleased:
                    lastTouchEvent = currentTouchEvent;
                    if (lastTouchEvent != null && onTouchRefreshLoadMoreListener != null) {
                        onTouchRefreshLoadMoreListener.onMonitorTouchLoadMore();
                    }
                    break;
...
//    }
    ...
    //</editor-fold>
    //<editor-fold desc="判断是否在顶部 open interface">

    public boolean isScrollTop() {
        return mRefreshContent.isScrollTop();
    }
    ...
    public RefreshLayout setEnableFooterLocked(boolean mEnableFooterLocked) {
        this.mEnableFooterLocked = mEnableFooterLocked;
        return this;
    }
